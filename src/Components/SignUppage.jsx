  ...
  return (
    <div className="  md:mt-[140px]  ">
      <div className="flex flex-col  items-center welcome-bg-lg justify-center md:flex-row   ">
        <div
          className={`welcome-bg  ${styles.paddingX} h-[584px]  ${styles.boxWidth} mt-[155px] xs:mt-[120px] md:mt-[160px]  flex flex-col items-start md:justify-end justify-center `}
        >
          <div className={`  w-full  md:h-[744px] `}>
            <div className={`  mx-auto xl:w-[564px]  `}>
              <div className={` welcome mb-[64px] md:mb-[153px] `}>
                <h1
                  className={`${styles.heading1} xl:w-[564px] ss:text-[44px] ss:w-[560px] sm:w-[600px] sm:text-[50px] md:w-full   text-white mb-[32px]`}
                >
                  Ready to Bring Your Ideas to Life?
                </h1>
                
                <p className="font-nunito text-[15px] text-[#fff] xl:w-[564px] leading-[20px] md:w-full lg:w-[534px] ss:w-[541px] sm:w-[560px]   ss:text-[18px] ss:leading-[28px] ">
                  Sign up now to unlock a world of creative possibilities. From
                  custom designs to stunning merchandise, our platform empowers
                  you to make your mark. Join our community of passionate
                  creators and start making an impact today.
                </p>
              </div>
              <div className="">
        ...
        <div
          className={` w-full flex flex-col  items-center justify-center lg:px-[81px] ${styles.paddingX} md:h-[784px] md:py-0  sign bg-blue py-[64px] `}
        >
          <div className=" w-full  xl:w-[556px] ">
            ...
            <form className="flex flex-col gap-[24px] my-[24px]">
              ...
              <div className="relative">
                ...
                />
                <span
                  className="absolute right-[18px] cursor-pointer top-[20px] lg:text-[24px] text-[#fff] "
              ...
              <Button
                ...
                title={
                  <div className="flex flex-row items-center justify-center gap-[8px] ">
                    <span className="font-nunito font-semibold "> Create Account</span>
                    <span>
